<?php echo Form::open(array("class"=>"form-horizontal")); ?>
    ...
    <div class="row">
        ...
        array('class' => 'col-md-4 form-control', 'placeholder'=>'商品名'));
        ?>
</div>
  		</div>
  		<div class="form-group">
        <div class="col-xs-2">
          ...
          array('class' => 'col-md-8 form-control', 'rows' => 8, 'placeholder'=>'原価'));
        ?>
</div>
  		</div>
  		<div class="form-group">
        <div class="col-xs-2">
          ...
          array('class' => 'col-md-4 form-control', 'placeholder'=>'定価'));
        ?>
</div>
  		</div>
  		<div class="form-group">
