			...
			<td>
				<div class="btn-toolbar">
					<div class="btn-group">
						...
						<?php echo Html::anchor('sakana/delete/'.$item->id, '<i class="icon-trash icon-white"></i> 削除', array('class' => 'btn btn-sm btn-danger', 'onclick' => "return confirm('削除してもよろしいですか?')")); ?>					</div>
				</div>
