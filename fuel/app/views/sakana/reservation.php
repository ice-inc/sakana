	...
	<div class="form-inline">
		...
		<div class="row">
					<div class="form-group">
						<div class="col-xs-3">
					<?php echo Form::label('名字', 'last_name', array('class'=>'control-label'));?>
					<?php echo Form::input('last_name',
					Input::post('last_name', isset($client) ? $client->last_name:''),
					array('class' => 'col-md-4 form-control', 'placeholder'=>'名字'));
					?>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-4">
					<?php echo Form::label('名前', 'first_name', array('class'=>'control-label'));?>
					<?php echo Form::input('first_name',
					Input::post('first_name', isset($client) ? $client->first_name:''),
					array('class' => 'col-md-4 form-control', 'placeholder'=>'名前'));
					?>
				</div>
			</div>
			<div class="form-group">
